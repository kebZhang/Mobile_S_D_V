...
def download_win(url):
    ...
    if not os.path.isfile("./dm_collector/dm_collector_c.pyd"):
        urllib.request.urlretrieve(url + "dm_collector_c.pyd",
                                   "./dm_collector/dm_collector_c.pyd")
...
if platform.system() == "Darwin" or platform.system() == "Linux":
    ...
    PACKAGE_DATA = {'dm_collector': ['./dm_collector_c.pyd']}
...
setup(
    ...
    packages=['dm_collector',
              'dm_collector.dm_endec',
              ],
