...
enum LogPacketType {
    ...
    // Add
    LTE_ML1_DCI_Information_Repost = 0xB16C,
    LTE_RLC_DL_AM_Control_PDU = 0xB083,
    LTE_PDCP_DL_Data_PDU = 0xB0A1,
    LTE_PDCP_UL_Delay_Statistics = 0xB0B6,
    LTE_RRC_Supported_CA_Combos	= 0xB0CD,
    LTE_LL1_Serving_Cell_Measurement_Results = 0xB116,
    LTE_LL1_PCFICH_Decoding_Results = 0xB12A,
    LTE_LL1_RACH_TX_Report = 0xB144,
    LTE_ML1_Random_Access_Request_MSG1_Report = 0xB167,
    LTE_ML1_Random_Access_Response_MSG2_Report	= 0xB168,
    LTE_UE_Identification_Message_MSG3_Report = 0xB169,
    LTE_Contention_Resulution_Message_MSG4_Report = 0xB16A,
    LTE_ML1_GM_TX_Report=0xB16D,
    LTE_ML1_S_Criteria_Check_Procedure = 0xB17A,
    LTE_ML1_Idle_Measurement_Request = 0xB17D,
    LTE_ML1_Serving_Cell_Measurements_And_Evaluation=0xB17F,
    LTE_ML1_Intra_Frequency_Cell_Reselection_Payload = 0xB181,
    LTE_ML1_CA_Metrics_Log_Packet = 0xB184,
    LTE_ML1_AdvRx_IC_Cell_List = 0xB18F,
    LTE_ML1_Cell_Measurement_Results=0xB196,
    LTE_ML1_Serving_Cell_Information = 0xB197,
    LTE_ML1_Common_DC_Offset = 0xB1B2,
};
...
const ValueName LogPacketTypeID_To_Name [] = {
    ...
    //add
    {LTE_ML1_DCI_Information_Repost,
        "LTE_ML1_DCI_Information_Repost", true},
    {LTE_RLC_DL_AM_Control_PDU,
        "LTE_RLC_DL_AM_Control_PDU", true},
    {LTE_PDCP_DL_Data_PDU,
        "LTE_PDCP_DL_Data_PDU", true},
    {LTE_PDCP_UL_Delay_Statistics,
        "LTE_PDCP_UL_Delay_Statistics", true},
    {LTE_RRC_Supported_CA_Combos,
        "LTE_RRC_Supported_CA_Combos", true},
    {LTE_LL1_Serving_Cell_Measurement_Results,
        "LTE_LL1_Serving_Cell_Measurement_Results", true},   
    {LTE_LL1_PCFICH_Decoding_Results,
        "LTE_LL1_PCFICH_Decoding_Results", true},
    {LTE_LL1_RACH_TX_Report,
        "LTE_LL1_RACH_TX_Report", true},
    {LTE_ML1_Random_Access_Request_MSG1_Report,
        "LTE_ML1_Random_Access_Request_MSG1_Report", true},
    {LTE_ML1_Random_Access_Response_MSG2_Report,
        "LTE_ML1_Random_Access_Response_MSG2_Report", true},
    {LTE_UE_Identification_Message_MSG3_Report,
        "LTE_UE_Identification_Message_MSG3_Report", true},
    {LTE_Contention_Resulution_Message_MSG4_Report,
        "LTE_Contention_Resulution_Message_MSG4_Report", true},
    {LTE_ML1_GM_TX_Report,
        "LTE_ML1_GM_TX_Report", true},
    {LTE_ML1_S_Criteria_Check_Procedure,
        "LTE_ML1_S_Criteria_Check_Procedure", true},
    {LTE_ML1_Idle_Measurement_Request,
        "LTE_ML1_Idle_Measurement_Request", true},
    {LTE_ML1_Serving_Cell_Measurements_And_Evaluation,
        "LTE_ML1_Serving_Cell_Measurements_And_Evaluation", true},
    {LTE_ML1_Intra_Frequency_Cell_Reselection_Payload,
        "LTE_ML1_Intra_Frequency_Cell_Reselection_Payload", true},
    {LTE_ML1_CA_Metrics_Log_Packet,
        "LTE_ML1_CA_Metrics_Log_Packet", true},
    {LTE_ML1_AdvRx_IC_Cell_List,
        "LTE_ML1_AdvRx_IC_Cell_List", true},
    {LTE_ML1_Cell_Measurement_Results,
        "LTE_ML1_Cell_Measurement_Results", true},
    {LTE_ML1_Serving_Cell_Information,
        "LTE_ML1_Serving_Cell_Information", true},
    {LTE_ML1_Common_DC_Offset,
        "LTE_ML1_Common_DC_Offset", true},
};
